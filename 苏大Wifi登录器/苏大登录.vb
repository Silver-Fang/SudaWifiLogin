...
Module 苏大登录
	Private HTTP客户端 As New HttpClient, 请求正文 As New Dictionary(Of String, String) From {{"domain", ""}, {"enablemacauth", "1"}}
	...
	Async Function 尝试登录(用户名 As String, 密码 As String) As Task(Of String)
